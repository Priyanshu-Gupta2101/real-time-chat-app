...
export function Chat() {
  ...
  return (
    <div
      key="1"
      className="flex h-screen bg-white dark:bg-zinc-800 border-r transition-all duration-300"
    >
      <aside
        className={`w-${
          isAsideCollapsed ? "5" : "80"
        } border-r dark:border-zinc-700 `}
      >
        <div className="p-4 space-y-4">
          <div className="flex justify-between items-center">
            <h2 className="text-xl font-bold">Message.io</h2>
